...
import { getModulo, saveModulo } from "../../../services/SetorService";
...
const ModalConfigModulo: React.FC<ModalProps> = (props) => {
  ...
  useEffect(() => {
    ...
    if (props.estabelecimento?.id) {
      getModulo(props.estabelecimento.id)
        .then((response) => {
    ...
    <div>
      <InputCheck
        ...
        onChange={(e) =>
          setConfigModulo(
            e.target.checked
              ? { ...configModulo, orcamento: "S" }
              : { ...configModulo, orcamento: "N" }
          )
        }
      />
      <InputCheck
        ...
        onChange={(e) =>
          setConfigModulo(
            e.target.checked
              ? { ...configModulo, pedido: "S" }
              : { ...configModulo, pedido: "N" }
          )
        }
      />
      <InputCheck
        ...
        onChange={(e) =>
          setConfigModulo(
            e.target.checked
              ? { ...configModulo, prevenda: "S" }
              : { ...configModulo, prevenda: "N" }
          )
        }
      />
      <InputCheck
        css="mb-5"
        label="Modo de cadastro para Filial"
        checked={configModulo?.filial === "S" ? true : false}
        onChange={(e) =>
          setConfigModulo(
            e.target.checked
              ? { ...configModulo, filial: "S" }
              : { ...configModulo, filial: "N" }
          )
        }
      />
    </div>
    ...
    <div>
      <InputCheck
        ...
        onChange={(e) =>
          setConfigModulo(
            e.target.checked
              ? { ...configModulo, transferenciaEstoque: "S" }
              : { ...configModulo, transferenciaEstoque: "N" }
          )
        }
      />
    </div>
    ...
    <div>
      <InputCheck
        ...
        onChange={(e) =>
          setConfigModulo(
            e.target.checked
              ? { ...configModulo, contas: "S" }
              : { ...configModulo, contas: "N" }
          )
        }
      />
      <InputCheck
        ...
        onChange={(e) =>
          setConfigModulo(
            e.target.checked
              ? { ...configModulo, controleCaixa: "S" }
              : { ...configModulo, controleCaixa: "N" }
          )
        }
      />
      <InputCheck
        ...
        onChange={(e) =>
          setConfigModulo(
            e.target.checked
              ? { ...configModulo, planoContas: "S" }
              : { ...configModulo, planoContas: "N" }
          )
        }
      />
    </div>
    ...
    <div>
      ...
      <InputCheck
        ...
        onChange={(e) =>
          setConfigModulo(
            e.target.checked
              ? { ...configModulo, balanca: "S" }
              : { ...configModulo, balanca: "N" }
          )
        }
      />
    </div>
  ...
  return (
    ...
    >
      <header
        ...
        style={{ backgroundColor: colors.gray, marginTop: "-8px" }}
      >
        <div className="flex font-bold">
          <div className="w-10/12 text-left">
            <p className=" mb-2">
              <span
                className="mr-1"
                style={{
                  color: title === "dark" ? colors.textLabel : colors.primary,
                }}
              >
                Código:
              </span>
            ...
            <label className="mr-5">
              ...
              {UtilsConvert.setMaskCpfCnpj(
                props.estabelecimento?.cnpjCpf !== undefined
                  ? props.estabelecimento?.cnpjCpf
                  : ""
              )}
            </label>
            <label>
          ...
          <div
            className="w-2/12 flex rounded-full items-center justify-center h-12 mt-1"
            style={{
              backgroundColor:
                props.estabelecimento?.status === "S"
                  ? colors.success
                  : colors.error,
      ...
      <div
        className="w-full h-full flex mt-3 font-bold text-left"
      ...
      >
        ...
        <hr
          className="linha-vertical mt-8 mr-4 h-full"
        ...
        <div className="w-3/12">
          <InputSelectDefault
            ...
            options={options}
            isSearchable={false}
            onChange={(e) => onChangeModulo(e.value)}
          />
        </div>
      </div>
      <footer className="">
